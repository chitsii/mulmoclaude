...
//
// Dedup key: `stableItemId` (FNV-1a of the normalized URL; the
// item shape already carries this as `item.id`). Items retain
// the first-seen occurrence and drop subsequent ones. Order is
// preserved so the caller's sort (e.g. newest-first across all
// sources) survives dedup.
